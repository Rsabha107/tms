...
class BookingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tms.admin.booking.list', compact('bookings'));
    }
    ...
    public function create()
    {
        ...
        $destinations = Destination::all();
        $booking_slots = BookingSlots::all();
        return view('tms.admin.booking.create', compact('teams', 'destinations', 'booking_slots'));
    }
    ...
    public function list(Request $request)
    {
        ...
        $ops = $ops->paginate(request("limit"))->through(function ($op) {
            ...
            $actions =
                ...
                $op->id .
                '" data-table="tms_bookings_table" data-bs-toggle="tooltip" data-bs-placement="right" title="View Booking Details">' .
                ...
                $op->id .
                '" data-table="tms_bookings_table" data-bs-toggle="tooltip" data-bs-placement="right" title="Generate Pass">' .
                ...
                $op->id .
                '" data-table="tms_bookings_table" data-bs-toggle="tooltip" data-bs-placement="right" title="Update">' .
                '<i class="fa-solid fa-pen-to-square text-primary"></i></a>' .
                '<a href="javascript:void(0)" class="btn btn-sm" data-table="tms_bookings_table" data-id="' .
                $op->id .
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tms.admin')->with($notification);
    }
    ...
    public function switch($id)
    {
        if ($id) {
            if (Event::findOrFail($id)) {
                ...
                return redirect()->route('tms.admin.booking')->with('message', 'Event Switched.');
    ...
    public function pickEvent(Request $request)
    {
        ...
        return redirect()->route('tms.admin.booking')->with('error', 'Event not found.');
        // }
    }
}
