...
@if (Request::is('mds/setting/funcareas*'))
<!-- venues modal -->
        ...
        <div class="modal-content bg-100">
            ...
            <div class="modal-body">
                <div class="mb-3 col-md-12">
                    ...
                    <select class="form-select" name="venue_id" id="add_schedule_times">
                    </select>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="select_time_btn"><?= get_label('select', 'Select') ?></label></button>
            </div>
        </div>
    </div>
</div>
...
@if (Request::is('mds/setting/status/booking*'))
<!-- venues modal -->
...
@if (Request::is('mds/setting/zone*'))
<!-- venues modal -->
...
@if (Request::is('mds/setting/interval/manage*'))
<!-- intervalss modal -->
...
@if (Request::is('mds/setting/vehicle'))
<!-- vehicles modal -->
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event" action="{{route('mds.setting.vehicle.store')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <input required type="text" id="nameBasic" class="form-control" name="status_id" placeholder="<?= get_label('please_enter_status', 'Please enter status') ?>" />
                    </div>
...
@if (Request::is('mds/setting/vehicle_type*'))
<!-- vehicle_types modal -->
