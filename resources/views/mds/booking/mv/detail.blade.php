                        ...
                        <div class="col-12 col-md-auto">
                            <div class="d-flex">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-0" style="z-index: 9999;">
                                    ...
                                    <li><a class="dropdown-item" href="{{route('mds.booking.pass.pdf', $booking->id)}}" target="_blank" id="generateBookingPass" data-id="{{$booking->id}}">Pass</a></li>
                        ...
                        <div class="tab-content mt-3" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="tab-booking-note" role="tabpanel" aria-labelledby="booking-note-tab">
                                ...
                                <div class="collapse" id="collapseBookingNote">
                                    <form class="needs-validation form-submit-booking-new-note" novalidate="" action="{{ route('mds.booking.note.store') }}" method="POST" id="form_submit_booking_new_note">
                                        @csrf
                            ...
                            <div class="tab-pane fade" id="tab-booking-file" role="tabpanel" aria-labelledby="mds-file-tab">
                                ...
                                <div class="collapse" id="collapseBookingFile">
                                    ...
                                    <form id="form_submit_task_new_file" class="needs-validation form-submit-booking-new-file" novalidate="" action="{{ route('tracki.task.file.store') }}" method="POST" enctype='multipart/form-data'>
                                        @csrf
