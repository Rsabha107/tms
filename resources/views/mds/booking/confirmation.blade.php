        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('mds.booking.add')}}">
    ...
    <div class="container">
        ...
        <div class="card shadow-none border my-4 col-md-8" style="margin:0 auto;" data-component-card="data-component-card">
            ...
            <div class="col-12 col-md-auto d-flex">
              <a href="{{route('mds.booking')}}"><button class="btn btn-phoenix-secondary px-3 px-sm-5 me-2">
              <!-- <span class="fa-solid fa-edit me-sm-2"></span> -->
              <span class="d-none d-sm-inline">See booking details</span></button></a>
              <a href="{{route('mds.booking.pass.pdf', $data->id)}}" target="_blank"><button class="btn btn-phoenix-primary me-2">
