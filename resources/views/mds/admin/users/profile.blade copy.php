                                        ...
                                        <div class="text-center mb-3">
                                            <div class="d-flex align-items-end position-relative mb-7 flex-center">
                                                ...
                                                <div class="hoverbox" style="width: 150px; height: 150px">
                                                    <div class="hoverbox-content rounded-0 d-flex flex-center z-1"
                                                        style="--phoenix-bg-opacity: .56;"><svg
                                                            class="svg-inline--fa fa-camera fs-1 text-body-quaternary"
                                                            aria-hidden="true" focusable="false" data-prefix="fas"
                                                            data-icon="camera" role="img"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                            data-fa-i2svg="">
                                                            <path fill="currentColor"
                                                                d="M149.1 64.8L138.7 96H64C28.7 96 0 124.7 0 160V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V160c0-35.3-28.7-64-64-64H373.3L362.9 64.8C356.4 45.2 338.1 32 317.4 32H194.6c-20.7 0-39 13.2-45.5 32.8zM256 192a96 96 0 1 1 0 192 96 96 0 1 1 0-192z">
                                                            </path>
                                                        </svg><!-- <span class="fa-solid fa-camera fs-1 text-body-quaternary"></span> Font Awesome fontawesome.com -->
                                                    </div>
                                                    <div
                                                        class="position-relative bg-body-quaternary rounded-0 cursor-pointer d-flex flex-center mb-xxl-7">
                                                        <div class="avatar avatar-5xl"><img id="showImage" class="rounded-0" --}}
                                                                {{-- src="{{ !empty($user->photo) ? url('upload/admin_images/' . $user->photo) : url('upload/user_profile_Image.png') }}" --}} 
                                                                {{-- src="{{ route('a', $file) }}" --}}
                                                                {{-- alt="">
                                                        </div>
                                                ...
                                                <div class="d-flex align-items-end position-relative mb-7 flex-center">
                                                    ...
                                                    <div class="hoverbox" style="width: 150px; height: 150px">
                                                        ...
                                                        <div
                                                            class="position-relative bg-body-quaternary rounded-0 cursor-pointer d-flex flex-center mb-xxl-7">
                                                            <div class="avatar avatar-5xl"><img id="showImage" class="rounded-0"
                                                                    {{-- src="{{ !empty($user->photo) ? url('upload/admin_images/' . $user->photo) : url('upload/user_profile_Image.png') }}" --}} src="{{ route('a', $file) }}"
                                                                    alt="">
                                                            </div>
                                                            <label class="w-100 h-100 position-absolute z-1"
                                                                for="upload-avatar"></label>
