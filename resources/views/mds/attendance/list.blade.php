                        ...
                        <div class="card-header p-4 border-bottom border-300 bg-soft">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md">
                                    <h4 class="text-900 mb-0" data-anchor="data-anchor">Master Guest List</h4>
                                </div>
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        ...
                                        <a class="btn btn-sm btn-phoenix-warning preview-btn ms-2" href="{{ route('main.attendance.import') }}"><span class="fa-solid fa-add"></span>Import</a>
                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn-sm " id="editXAttend" data-toggle="modal" data-target='#editModal' data-route="attendance" data-id="{{ $item->id }}">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            @endif
                                                            @if (Auth::user()->can('attendance.delete'))
                                                            <a href="{{ route('main.attendance.list.delete',$item->id)}} " class="btn btn-sm  delete" id="delete">
