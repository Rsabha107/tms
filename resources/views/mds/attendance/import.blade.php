...
<div class="content">
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="d-sm-flex justify-content-between">
                    <h2 class="mb-4">Import Master Guest</h2>
                    <div class="d-flex mb-3">
                        <a class="btn btn-phoenix-danger me-2 px-6" href="{{ route('main.attendance.list') }}">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-8">
            <form action="{{ route ('main.attendance.import.now') }}" class="row g-3 mb-9 needs-validation" novalidate="" method="post" enctype="multipart/form-data">
                @csrf
