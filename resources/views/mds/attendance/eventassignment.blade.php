                        ...
                        <div class="card-header p-4 border-bottom border-300 bg-soft">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="hidden" name="event_id" value="{{$event_id}}" id="selectedEventAssignment">
                                </div>
                                                ...
                                                <tr id="attendance_ids{{ $item->id }}">
                                                    ...
                                                    <!-- <td class="text-end">
                                                        <div class="actions">
                                                            ...
                                                            <a href="{{ route('tracki.attendance.list.delete',$item->id)}} " class="btn btn-sm bg-danger-light delete" id="delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('tracki.attendance.list.create') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('tracki.attendance.list.update') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#assignToEvent').click(function(e) {
                ...
                $.ajax({
                    url: "{{ route('tracki.attendance.assignevents') }}",
                    type: "post",
                    data: {
                    ...
                    success: function(response) {
                        ...
                        //     'alert-type' => 'success'
                        // );
                        x = "{{route('tracki.task.list',':selectEventAssignment')}}"
