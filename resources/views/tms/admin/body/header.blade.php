@php
    ...
    //     $event = App\Models\Tms\Setting\Event::findOrFail($current_event_id);
        ...
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ route('mds.admin') }}">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('assets/img/icons/mds.jpg') }}" alt="{{ __('bookapp.page_title') }}"
                            width="27" />

                        {{-- @if ($session_set) --}}
                        <h3 class="logo-text ms-2 d-none d-sm-block">{{ __('tms.page_title') }} </h3>
                        ...
                        {{-- @else
                        <h6 class="logo-text ms-2 d-none d-sm-block">{{ __('bookapp.page_title') }}</h6>
                            @endif --}}
                                        ...
                                        <div class="row text-center align-items-center gx-0 gy-0">
                                            <div class="col-4"><a
                                                    ...
                                                    href="{{ route('home') }}"><img src="../../assets/img/nav-icons/bitbucket.webp"
                                                        alt="" width="30">
                                                    <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">TMS</p>
                                                </a>
                                            </div>
                                            <div class="col-4"><a
                                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="{{ route('home') }}"><img src="../../assets/img/nav-icons/figma.webp"
                                                        alt="" width="20">
                                                    <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">TMS</p>
                                                </a>
                                            </div>
