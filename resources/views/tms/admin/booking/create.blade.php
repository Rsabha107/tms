{{-- @include('layouts.tms.admin_template') --}}
    ...
    <div class="mb-9" data-bs-spy="scroll" data-bs-target="#widgets-scrollspy">
        ...
        <div class="row g-3">
            ...
            <div class="row gy-3 h-100">
                <div class="col-12">
                    <div class="card mb-3 h-50  card-toscroll">
                        <div class="card-header">
                            <h3 class="mb-4">Select a Team</h3>
                        </div>
                        <div class="scrollable-card">
                            <div class="card-body">
                                <!-- style="height: 10px; overflow-y: auto" -->
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group mb-5" id="myTab" role="tablist">
                                    ...
                                    <li class="list-group-item list-group-item-action destination-list"
                                        data-destination-id="{{ $destination->id }}" href="#!">{{ $destination->title }}</li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="modal-body text-center mb-3">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 mb-sm-2">
                                            ...
                                            <select class="form-select" id="tms_team_select_id">
                                        ...
                                        <div class="col-12 col-sm-6 mb-sm-2">
                                            <select class="form-select" id="tms_destination_select_id">
                    ...
                    <div class="col-12">
                        <div class="card mb-3 h-100">
                            <div class="card-body">
                                ...
                                <form id="tms_form" action="{{ route('tms.admin.booking.store') }}" method="post"
                                        class="needs-validation" novalidate>
                                        @csrf
                                <input type="hidden" name="team_id" id="tms_team_id">
                                <input type="hidden" name="destination_id" id="tms_destination_id">
                                <input type="hidden" name="booking_date" id="tms_booking_date">

                                <div id="show_schedule_times"></div>

                                {{-- <button type="submit" class="btn btn-primary mt-3">Book Appointment</button> --}}
                                <button type="submit" class="btn btn-primary mt-3" id="submit_booking" disabled>Book
                                    Appointment</button>
                                </form>
                            </div>
                        </div>
...
@endsection
{{-- @push('css')
    <link rel="stylesheet" href="{{ asset('css/tms/index.css') }}"> --}}
@push('script')
    <script src="{{ asset('assets/js/pages/tms/booking.js') }}"></script>
@endpush
