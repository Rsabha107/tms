...
<div class="d-flex justify-content-between m-2">
    ...
    <div>
        <a href="{{route('tms.admin.create')}}"><button type="button" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title=" <?= get_label('create_booking', 'Create Booking') ?>"><i class="bx bx-plus"></i></button></a>
    </div>
</div>
...
<x-tms.admin.booking-card :bookings="$bookings" />
<!-- </div> -->
