...
@if (Request::is('tracki/setup/funcareas'))
<!-- venues modal -->
<div class="modal fade" id="create_funcareas_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event" action="{{route('tracki.setup.funcareas.store')}}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_funcareas_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="edit_form_submit_event" action="{{route('tracki.setup.funcareas.update')}}" method="POST">
                @csrf
