                            ...
                            <div class="row g-3 justify-content-between align-items-center">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        ...
                                        <a class="btn btn-sm btn-phoenix-primary preview-btn ms-2" href="{{ route('main.setup.fa.add')}}"><span class="fa-solid fa-add"></span>Add</a>
                                        ...
                                        <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden" id="dataList">
                                            <thead class="text-900">
                                                <tr>
                                                    ...
                                                    <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 4.5rem;">Budget</th>
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-3">{{ $item->budget_name }}</td>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="{{ route('main.setup.fa.show.edit',$item->id) }}">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="{{ route('main.setup.fa.delete',$item->id)}} " class="btn btn-sm  delete" id="delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('main.setup.fa.create') }}" method="POST">
                    @csrf
                            ...
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" type="text" placeholder="Enter name" name="budget_name" id="addName" required />
                                    </div>
                                    <!-- <div class="mb-4">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('main.setup.fa.update') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
