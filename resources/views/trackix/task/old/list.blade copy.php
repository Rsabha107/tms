                            ...
                            <div class="pb-3">
                                <div class="row align-items-center g-3 g-sm-5 text-center text-sm-start">
                                    ...
                                    <div class="d-grid gap-2">
                                        <button class="btn btn-phoenix-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Show description</button>
                                    </div>
                                </div>
                            </div>
                            @if (Auth::user()->can('task.funds.show'))
    ...
    <div class="row g-3 mb-6">
        ...
        <div class="collapse" id="collapseExample">
            <div class="border border-translucent p-3 rounded">{{$eventData->description}}</div>
                ...
                <div class="tab-pane fade active" id="tab-activity" role="tabpanel" aria-labelledby="activity-tab">
                    <div class="card">
                        <div class="mb-9">
                            <div id="orderTable" data-list='{"valueNames":["name","start_date","due_date","department","assigned_to","status","description"]}'>
                                ...
                                <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 position-relative top-1">
                                    <div class="table-responsive ms-n1 px-2 scrollbar">
                                        ...
                                        <table class="table table-sm table-hover table-responsive fs--1 mb-0 overflow-hidden" id="dataList">
                                            ...
                                            <tbody class="list" id="order-table-body">
                                                ...
                                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                                    ...
                                                    if (($item->status_name != 'Completed') && ($taskDateDiff <= 3)){ $badge_color='badge-phoenix-danger' ; } @endphp <td class="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-700">
                                                        <span class="badge badge-phoenix fs--2 {{$badge_color}} ms-5"><span class="badge-label" data-bs-toggle="modal" data-bs-target="#taskStatusModal" id="editTaskStatus" data-id="{{ $item->id }}">{{$item->status_name}}</span><span class="ms-1" data-feather="x" style="height:12.8px;width:12.8px;"></span></span>
                                                        </td>
                                                        ...
                                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                                                            <div class="font-sans-serif btn-reveal-trigger position-static">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                                    ...
                                                                    @endif
                                                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#taskStatusModal" id="editTaskStatus" data-id="{{ $item->id }}" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">Change Status</a>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="status_id" class="form-select" id="editTaskStatusSelection" required>
                                            ...
                                            @foreach ($taskStatus as $key => $item )
