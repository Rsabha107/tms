...
<div class="content">
                        ...
                        <div class="card-header p-4 border-bottom border-300 bg-soft">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md-6">
                                    <h4 class="text-900 mb-0" data-anchor="data-anchor">Attendance Assignment</h4>
                                </div>
                                <div class="form-floating col-md-6">
                                    <select name="event_id" class="form-select event_id" id="selectedEventAssignment" required>
                                    ...
                                    <label for="selectedEventAssignment">Events</label>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <!-- <button class="btn btn-primary me-4" type="button" data-bs-toggle="modal"
                                            ...
                                            Deal</button> -->
                                        <a href="#" class="btn btn-sm btn-phoenix-primary preview-btn ms-2" id="assignToEvent"><span class="fa-solid fa-add"></span>Assign to evnet</a>
                                    </nav>
                                </div>
                                <!-- <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                                    <li class="nav-item"><a class="nav-link active" aria-current="page" href=""><span>All </span><span class="text-700 fw-semi-bold">({{$allCount}})</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href=""><span>influencers </span><span class="text-700 fw-semi-bold">({{$infCount}})</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href=""><span>VIP </span><span class="text-700 fw-semi-bold">({{$vipCount}})</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href=""><span>VIC </span><span class="text-700 fw-semi-bold">({{$vicCount}})</span></a></li>
                                </ul> -->
                            </div>
                        </div>
                            ...
                            <div class="p-4 code-to-copy">
                                    ...
                                    <div class="table-responsive scrollbar mb-3">
                                        <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden" id="dataList">
                                            <thead class="text-900">
                                                <tr>
                                                    <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 1.5rem;"><input class="form-check-input" type="checkbox" id="select_all_ids"></th>
                                                    <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 4.5rem;">First Name</th>
                                                    <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 4.5rem;">Last Name</th>
                                                    ...
                                                    <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 4.5rem;">Type</th>
                                ...
                                <th class="no-sort"></th> -->
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr id="attendance_ids{{ $item->id }}">
                                                    <td class="ps-3"><input class="form-check-input checkbox_ids" name="ids" type="checkbox" value="{{ $item->id }}"></td>
                                                    <td class="ps-3">{{ $item->first_name }}</td>
                                                    <td class="ps-3">{{ $item->last_name }}</td>
                                                    <td class="ps-3">{{ $item->email_address }}</td>
                                                    <td class="ps-3">{{ $item->phone_number }}</td>
                                                    <td class="ps-3">{{ $item->attendance_type }}</td>
                                                    ...
                                                    <!-- <td class="text-end">
                                                        <div class="actions">
                                                            <a href="javascript:void(0)" class="btn btn-sm bg-danger-light" id="editXAttend" data-toggle="modal" data-target='#editModal' data-route="attendance" data-id="{{ $item->id }}">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="{{ route('main.attendance.list.delete',$item->id)}} " class="btn btn-sm bg-danger-light delete" id="delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                <div class="modal-header" style="background-color: rgb(8 47 73);">
                    <h3 class=" text-black mb-0" id="staticBackdropLabel">Add</h3>
                ...
                <form class="needs-validation" novalidate="" action="{{ route('main.attendance.list.create') }}" method="POST">
                    @csrf
                        ...
                        <div class="modal-body px-0">
                            <div class="row g-6">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">First Name</label>
                                        <input class="form-control" type="text" placeholder="Enter name" name="first_name" id="addName" required />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Last Name</label>
                                        <input class="form-control" type="text" placeholder="Enter name" name="last_name" id="addName" required />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Email</label>
                                        <input class="form-control" type="text" placeholder="Enter name" name="email_address" id="addName" required />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Phone</label>
                                        <input class="form-control" type="text" placeholder="Enter name" name="phone_number" id="addName" required />
                                    </div>
                                    <div class="mb-4">
                                        <select name="type_id" class="form-select" id="floatingSelectRating" required>
                                            <option selected="selected" value="">Select</option>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                <div class="modal-header" style="background-color: rgb(8 47 73);">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('main.attendance.list.update') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">First name</label>
                                        <input class="form-control" type="text" placeholder="Enter first name" name="first_name" id="editFirstName" required />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Last name</label>
                                        <input class="form-control" type="text" placeholder="Enter last name" name="last_name" id="editLasttName" required />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Email</label>
                                        <input class="form-control" type="text" placeholder="Enter email" name="email_address" id="editEmailAddress" required />
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-1000 fw-bold mb-2">Last name</label>
                                        <input class="form-control" type="text" placeholder="Enter phone" name="phone_number" id="editPhoneNumber" required />
                                    </div>
                                    <div class="mb-4">
                                        <select name="type_id" class="form-select" id="editTypeId" required>
