        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-home">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('mds.admin.dashboard') }}">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-MDS">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('mds/admin/booking')||Request::is('mds/admin/booking/create') ? 'show' : '' }}" data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                ...
                                <li class="nav-item"><a class="nav-link {{ Request::is('mds/admin/booking') ? 'active' : '' }}" href="{{route('mds.admin.booking')}}">
                ...
                <li class="nav-item">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/rsp') ? 'active' : '' }}" href="{{route('mds.setting.rsp')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Remote Search Park</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/vehicle_type') ? 'active' : '' }}" href="{{route('mds.setting.vehicle_type')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/delivery_type') ? 'active' : '' }}" href="{{route('mds.setting.delivery_type')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Dispatch Type</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/cargo') ? 'active' : '' }}" href="{{route('mds.setting.cargo')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Cargo</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/schedule') ? 'active' : '' }}" href="{{route('mds.setting.schedule')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/funcareas') ? 'active' : '' }}" href="{{route('mds.setting.funcareas')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/venue') ? 'active' : '' }}" href="{{route('mds.setting.venue')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/zone') ? 'active' : '' }}" href="{{route('mds.setting.zone')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Loading Zone</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/status/booking') ? 'active' : '' }}" href="{{route('mds.setting.status.booking')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Booking Status</span></span>
                            </div>
                        </a>
                    </div>
                    @endcan
