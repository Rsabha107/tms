                    ...
                    <div class="card position-relative border-0">
                        ...
                        <div class="overflow-auto scrollbar" style="height: 10rem;">
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                <li class="nav-item"><a class="nav-link px-3" href="{{route('mds.customer')}}"> <span class="me-2 text-900" data-feather="user"></span><span>Profile</span></a></li>
                                <li class="nav-item"><a class="nav-link px-3" href="{{ route('mds.customer')}}"><span class="me-2 text-900" data-feather="pie-chart"></span>Dashboard</a></li>
