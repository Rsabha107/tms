        ...
        <div class="table-responsive text-nowrap">
            ...
            <div class="mb-4 mt-2">
                <div class="row g-1 mx-2">
                    ...
                    @endphp
                    @if (Request::routeIs('tracki.employee.profile'))
                ...
                <table table-stripped id="project_table" data-toggle="table"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-formatter="actionsPerProjectFormatter"><?= get_label('actions', 'Actions') ?></th>
                        </tr>
                    </thead>
                </table>
            </div>
