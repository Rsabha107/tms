        ...
        <div class="table-responsive text-nowrap">
            ...
            <div class="mb-4 mt-2">
                <div class="row g-1 mx-2">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="#" id="add_task" data-action="store" data-source="list" data-type="add" data-table="task_table" data-id="0" data-projectId="{{$proj_id}}">
            ...
            <div class="mx-2 mb-2">
                <table  table-stripped id="task_table"
                        ...
                        data-url="{{ route('tracki.task.dtable', $showpageid)}}"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" data-field="event_id"><?= get_label('project', 'Project') ?></th>
