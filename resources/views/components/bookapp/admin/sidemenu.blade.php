            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-MDS">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('bookapp') ? 'show' : '' }}" data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                <li class="collapsed-nav-item-title d-none">TDS
                                </li>
                                <li class="nav-item"><a class="nav-link {{ Request::is('bookapp') ? 'active' : '' }}" href="{{route('bookapp')}}">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">List of Bookings</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link {{ Request::is('bookapp/create') ? 'active' : '' }}" href="{{route('mds.admin.booking.create')}}">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/rsp') ? 'active' : '' }}" href="{{route('mds.setting.rsp')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Teams</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/vehicle_type') ? 'active' : '' }}" href="{{route('mds.setting.vehicle_type')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Destinations</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
