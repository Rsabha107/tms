        ...
        <div class="table-responsive text-nowrap">
            ...
            <div class="mx-2 mb-2">
                <table  id="venues_table"
                        ...
                        data-url="{{ route('mds.setting.venue.list')}}"
                    ...
                    <thead>
                        ...
                        <th data-sortable="true" data-field="short_name" class="align-middle white-space-wrap fw-bold fs-9"><?= get_label('short_name', 'Short Name') ?></th>
