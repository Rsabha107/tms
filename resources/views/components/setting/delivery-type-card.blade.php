...
<div class="card mt-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            {{$slot}}
            @if (is_countable($deliverytypes) && count($deliverytypes) > 0)
            ...
            <div class="mx-2 mb-2">
                <table  id="delivery_types_table"
                    ...
                    <thead>
                        ...
                        <th data-sortable="true" data-field="title" class="align-middle white-space-wrap fw-bold fs-9"><?= get_label('name', 'Name') ?></th>
