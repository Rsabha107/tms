            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-home">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('tms.admin.dashboard') }}">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-MDS">
                            <div class="d-flex align-items-center">
                                <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="phone"></span></span><span class="nav-link-text">TMS</span>
                            </div>
                        </a>
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('bookapp') ? 'show' : '' }}" data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                <li class="collapsed-nav-item-title d-none">TMS
                                </li>
                                <li class="nav-item"><a class="nav-link {{ Request::is('bookapp') ? 'active' : '' }}" href="{{route('home')}}">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">List of Bookings</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link {{ Request::is('bookapp/create') ? 'active' : '' }}" href="{{route('tms.admin.create')}}">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('tms/setting/event') ? 'active' : '' }}" href="{{route('tms.setting.event')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('tms/setting/team') ? 'active' : '' }}" href="{{route('tms.setting.team')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Team</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('tms/setting/destination') ? 'active' : '' }}" href="{{route('tms.setting.destination')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Destination</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('tms/setting/schedule') ? 'active' : '' }}" href="{{route('tms.setting.schedule')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Schedule</span></span>
                            </div>
                        </a>
                    </div>
                    <!-- parent pages-->
