$(document).ready(function () {
    ...
    $("body").on("click", "#editRsp", function () {
        console.log('inside edit_rsp')
        var id = $(this).data("id");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#edit_rsp_id").val(response.op.id);
                $("#edit_rsp_name").val(response.op.title);
                $("#editActiveFlag").val(response.op.active_flag);
                $("#edit_rsp_table").val(table);
