$(document).ready(function () {
    ...
    $("body").on("click", "#edit_booking_slot_offcanv", function () {
        ...
        $.ajax({
            url: "/tms/setting/schedule/mv/get/" + id,
            method: "GET",
            async: true,
    ...
    $("body").on("click", "#delete_booking_slot", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/tms/setting/schedule/delete/" + id,
                    type: "DELETE",
                    headers: {
    ...
    $("body").on("click", "#editSchedule", function () {
        ...
        var table = $(this).data("table");
        $.ajax({
            url: "/tms/setting/schedule/get/" + id,
            type: "get",
            headers: {
...
$("body").on("click", "#editScheduleStatus", function (event) {
    ...
    $.get("/tms/schedule/status/edit/" + id , function (data) {
...
function actionsFormatter(value, row, index) {
    ...
    //     '<a href="/tms/setting/interval/manage/'+ row.id + '" class="btn btn-sm" id="schedule_intervals" data-id="' +
    //     row.id +
