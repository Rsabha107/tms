    ...
    $("body").on("click", "#editZone", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#edit_zone_id").val(response.venue.id);
                $("#edit_zone_title").val(response.venue.title);
                $("#edit_zone_venue_id").val(response.venue.venue_id);
...
$("body").on("click", "#deleteZone", function (e) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "/mds/setting/zone/delete/" + id,
                type: "DELETE",
                headers: {
                    "X-CSRF-TOKEN": $('input[name="_token"]').attr("value"), // Replace with your method of getting the CSRF token
                },
