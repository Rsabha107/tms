    ...
    if (calendarEl) {
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            dateClick: function (info) {
                ...
                $("#bookapp_booking_date").val(info.dateStr);

                console.log(
                    "destination_id: " + $("#bookapp_destination_id").val()
                );
                console.log("team_id: " + $("#bookapp_team_id").val());
                console.log(
                    "bookapp_booking_date: " + $("#bookapp_booking_date").val()
                );
    ...
    $("body").on("click", "#deleteBooking", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/bookapp/admin/booking/delete/" + id,
                    type: "DELETE",
                    headers: {
                        "X-CSRF-TOKEN": $('input[name="_token"]').attr("value"), // Replace with your method of getting the CSRF token
                    },
